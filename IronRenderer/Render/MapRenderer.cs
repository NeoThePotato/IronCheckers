...
namespace IO.Render
{
	class MapRenderer : Renderer
	{
		...
		public static (int, int) PointToCharPos(Position point)
		{
			int charPosJ = point.TileJ;
			int charPosI = (point.TileI * STRECH_I) + STRECH_I * Position.PointRemainder(point.Y) / Position.POINTS_PER_TILE;
		...
		public static VisualTileInfo GetTileInfoAt(Map map, Position point)
		{
