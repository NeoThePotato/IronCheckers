...
namespace IronRenderer
{
    ...
    public class ConsoleRenderer : IConsoleRenderer
    {
        ...
        private FrameBuffer FrameBufferStatic { get; set; }
        private StringBuilder StringBuffer { get; set; }
        private TileMapRenderer ChildRenderer { get; set; }
        private int BufferSizeJ => Buffer.SizeJ;
        private int BufferSizeI => Buffer.SizeI;
        private (int, int) BufferSize => (BufferSizeJ, BufferSizeI);
        private int BufferLength => BufferSizeJ * BufferSizeI;
        ...
        {
            ChildRenderer.Buffer = Buffer;
			ChildRenderer.UpdateFrame();
        }

        public void UpdateFrameFull()
		{
			ChildRenderer.Buffer = FrameBufferStatic;
			ChildRenderer.UpdateFrameFull();
        }
        ...
        {
            FrameBuffer.Copy(Buffer, FrameBufferStatic);
			UpdateFrameInternal();
        }
        ...
        private void UpdateFrameBufferSize(int sizeJ, int sizeI)
        {
            ...
            FrameBufferStatic = new FrameBuffer(sizeJ, sizeI);
        }
        ...
        public struct FrameBuffer
        {
            ...
            internal readonly int SizeJ
            { get => _sizeJ - OffsetJ; }
            internal readonly int SizeI
            { get => _sizeI - OffsetI; }
            internal readonly int OffsetJ
            { get => _offsetJ; }
            internal readonly int OffsetI
            { get => _offsetI; }
            ...
            internal struct OffsetBuffer<T>
            {
                ...
                internal int OffsetJ
                { get; private set; }
                internal int OffsetI
                { get; private set; }
        ...
        internal interface IConsoleRenderer : IRenderer
        {
            ...
            internal FrameBuffer Buffer { get; set; }
